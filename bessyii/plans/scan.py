...
class BessyScans:
    ...
    def scan_intervals(self, detectors, *args, num=None, per_step=None, md=None):
        """
        Scan over one multi-motor trajectory. with start and stop metadata. 
    ...
    def scan_stepsize(self, detectors, *args, step=None, per_step=None, md=None):
        """
        Scan over one multi-motor trajectory. with start and stop metadata
    ...
    def rel_scan_intervals(self, detectors, *args, num=None, per_step=None, md=None):
        """
        ...
        *args :
        ...
        def inner_rel_scan():
            return (yield from self.scan_intervals(detectors, *args, num=num,
                                    per_step=per_step, md=_md))
